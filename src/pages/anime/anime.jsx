    ...
    <Container>
      {error ? (
        ...
        <Row>
          ...
          <Col md={9}>
            <Nav fill variant="tabs" defaultActiveKey="/home" className="mt-2">
              <Nav.Item>
                <LinkContainer to={`/anime/${params.id}`}>
                  <Nav.Link>Details</Nav.Link>
                </LinkContainer>
              </Nav.Item>
              <Nav.Item>
                <LinkContainer to={`/anime/${params.id}/episodes`}>
                  <Nav.Link>Episodes</Nav.Link>
                </LinkContainer>
              </Nav.Item>
              <Nav.Item>
                <LinkContainer to={`/anime/${params.id}/videos`}>
